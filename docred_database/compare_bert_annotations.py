...
from ParseSyntaticTree import (Node, combination_between_noun_phrases,
                               ...
                               split_in_sentences)
from utils import compare_strings, get_most_similar_pair_entities
...
for index, row in df.iterrows():
    ...
    for tuple_nodes in combination_noun_phrases:
        ...
        if relation_found_by_path and entity_0 != entity_1:
            ...
            list_ents_similars, jw_factor = get_most_similar_pair_entities(df_docred_selected, entity_0, entity_1)
            print(f"SImilares pairs: {entity_0, entity_1}, {list_ents_similars}")
            similar_ents = False
