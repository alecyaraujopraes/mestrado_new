...
from functions_bert import (cosine_similarity, create_embeddings,
                            ...
                            get_idx_tokens_for_found_relations, get_vectors, sentence_similarity, sentence_transformer, simcse)

possible_relations = {
    "P6": "the head of government is", 
    "P17": "the country of", 
    "P19": "has the place of birth in", 
    "P20": "was the place of death", 
    "P22": "is father of", 
    "P25": "is mother of", 
    "P26": "is spouse of", 
    "P27": "country of citizenship", 
    "P30": "is the continent", 
    "P31": "instance of", 
    "P35": "is the head of state", 
